      ...
      <Flex pt="4">
        <Box flex="3" p="6" px="5">
          ...
          { course.purchased && course.price != 0 && (
            <Button mt="5" colorScheme="blue" onClick={ handleRefund }>
              { " " }
              Refund Course
            </Button>
          ) }
          ...
          { course.price != 0 && (
            <>
              <Button mt="5" colorScheme="blue" onClick={ handleRevenue }>
                { " " }
                Distribute Revenue
              </Button>
              <br />
          ...
          >
            { !course.purchased ? (
              <Flex direction="column">
                ...
                <Button mt="5" colorScheme="blue" onClick={ handlePurchase }>
                  { " " }
